...
//                        // requests.
//                        .addParameter("publicKey", GooglePayConstants.DIRECT_TOKENIZATION_PUBLIC_KEY)
//                        .build();
//
...
//    }
                ...
                PaymentDataRequest.newBuilder()
                        ...
                        .setShippingAddressRequirements(
                                ShippingAddressRequirements.newBuilder()
                                        .addAllowedCountryCodes(GooglePayConstants.SHIPPING_SUPPORTED_COUNTRIES)
                                        .build())
     ...
     * {@link GooglePayConstants#SUPPORTED_METHODS}.
     * <p>
